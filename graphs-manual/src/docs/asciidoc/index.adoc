...
----
compile group: 'com.github.moaxcp.graphs', name: 'graphs-core', version: '0.12.0'
----

`graphs-greenrobot` EventGraph implementation using greenrobot's EventBus

----
compile group: 'com.github.moaxcp.graphs', name: 'graphs-greenrobot', version: '0.12.0'
----

`graphs-graphviz` rendering of graph as png or animated gifs using graphviz

----
compile group: 'com.github.moaxcp.graphs', name: 'graphs-graphviz', version: '0.12.0'
----

`graphs-truth` assertions using google-truth

----
compile group: 'com.github.moaxcp.graphs', name: 'graphs-truth', version: '0.12.0'
----
...
Renaming Graph to PropertyGraph.
