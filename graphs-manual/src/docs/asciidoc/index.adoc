...
----
compile group: 'com.github.moaxcp.graphs', name: 'graphs-core', version: '0.14.0'
----

`graphs-greenrobot` EventGraph implementation using greenrobot's EventBus

----
compile group: 'com.github.moaxcp.graphs', name: 'graphs-greenrobot', version: '0.14.0'
----

`graphs-graphviz` rendering of graph as png or animated gifs using graphviz

----
compile group: 'com.github.moaxcp.graphs', name: 'graphs-graphviz', version: '0.14.0'
----

`graphs-graphviz-greenrobot-gif` rendering of graph as gif using graphviz and greenrobot

----
compile group: 'com.github.moaxcp.graphs', name: 'graphs-graphviz-greenrobot-gif', version: '0.14.0'
----

`graphs-truth` assertions using google-truth

----
compile group: 'com.github.moaxcp.graphs', name: 'graphs-truth', version: '0.14.0'
----
